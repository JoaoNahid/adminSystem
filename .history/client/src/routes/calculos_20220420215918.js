...
export default function Calculos() {
    ...
    function calcularConversao() {
        var pesoLote = document.getElementById('pesoLote').defaultValue
        var pesoPintinho = document.getElementById('pesoPintinho').defaultValue
        var qtdRacao = document.getElementById('qtdRacao').defaultValue
