...
export default function EdicaoPaginas(){ 
    ...
    const [posicaoItensMenuARenderizar, setPosicaoItensMenuARenderizar] = useState(null)
    //console.log(arrayComponetes[posicaoItensMenuARenderizar]['itensMenu'])
    

    if(menuARenderizar == ''){
        setMenuLateral(arrayComponetes[0]['itensMenu'])
    } else{
        setMenuLateral(arrayComponetes[posicaoItensMenuARenderizar]['itensMenu'])
    }
    console.log(posicaoItensMenuARenderizar);
