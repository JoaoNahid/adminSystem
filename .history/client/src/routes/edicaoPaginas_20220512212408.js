...
export default function EdicaoPaginas(){ 
    VerificaLogin();
    const [formularioARenderizar, setFormularioARenderizar] = useState(0)
    const [menuARenderizar, setMenuLateral] = useState('')
    const [posicaoItensMenuARenderizar, setPosicaoItensMenuARenderizar] = useState(1)

    console.log(arrayComponetes[posicaoItensMenuARenderizar]['itensMenu'][formularioARenderizar]['componente']);
        ...
        <div>
            ...
            <div className="container">
                <div className="areaEdicaoSite">
                    ...
                    <MenuLateral itemsMenu={arrayComponetes[posicaoItensMenuARenderizar]['itensMenu']} setFormularioARenderizar={setFormularioARenderizar} />
                </div>                
            </div>
        </div>
    )
